...
LABEL maintainer="sungyong"
LABEL org.label-schema.schema-version="1.0"
LABEL org.label-schema.name="sungyong/android-build-box"
LABEL org.label-schema.version="${DOCKER_TAG}"
LABEL org.label-schema.usage="/README.md"
LABEL org.label-schema.docker.cmd="docker run --rm -v `pwd`:/project sungyong/android-build-box bash -c 'cd /project; ./gradlew build'"
